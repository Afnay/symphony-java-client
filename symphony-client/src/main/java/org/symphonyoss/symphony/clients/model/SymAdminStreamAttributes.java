...
public class SymAdminStreamAttributes {
    ...
    /**
     * V2
     * @param v2AdminStreamAttributes
     * @return
     */
    public static SymAdminStreamAttributes toV2AdminStreamAttributes(V2AdminStreamAttributes v2AdminStreamAttributes) {
    	
    	SymAdminStreamAttributes symAdminStreamAttributes = new SymAdminStreamAttributes();
    	
    	symAdminStreamAttributes.setCreatedByUserId(v2AdminStreamAttributes.getCreatedByUserId());
    	symAdminStreamAttributes.setCreatedDate(v2AdminStreamAttributes.getCreatedDate());
    	symAdminStreamAttributes.setLastModifiedDate(v2AdminStreamAttributes.getLastModifiedDate());
    	symAdminStreamAttributes.setMembers(v2AdminStreamAttributes.getMembers());
    	symAdminStreamAttributes.setMembersCount(v2AdminStreamAttributes.getMembersCount());
    	symAdminStreamAttributes.setOriginCompany(v2AdminStreamAttributes.getOriginCompany());
    	symAdminStreamAttributes.setOriginCompanyId(v2AdminStreamAttributes.getOriginCompanyId());
    	symAdminStreamAttributes.setRoomDescription(v2AdminStreamAttributes.getRoomDescription());
    	symAdminStreamAttributes.setRoomName(v2AdminStreamAttributes.getRoomName());
