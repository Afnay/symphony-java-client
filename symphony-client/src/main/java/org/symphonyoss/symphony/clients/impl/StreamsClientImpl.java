...
public class StreamsClientImpl implements org.symphonyoss.symphony.clients.StreamsClient {
    ...
    /**
     * Retrieve all known streams based on filter as an Admin user V2
     *
     * @param skip  Skip number of stream entries
     * @param limit Limit number of results
     * @return {@link SymAdminStreamFilter}
     ...
     */
    @Override
    public SymAdminStreamList getV2Streams(Integer skip, Integer limit, SymAdminStreamFilter symAdminStreamFilter) throws StreamsException {
        ...
        try {
            ...
            V2AdminStreamList adminStreamList = streamsApi.v2AdminStreamsListPost(symAuth.getSessionToken().getToken(), skip, limit, filter);

            return SymAdminStreamList.toSymV2StreamList(adminStreamList);
