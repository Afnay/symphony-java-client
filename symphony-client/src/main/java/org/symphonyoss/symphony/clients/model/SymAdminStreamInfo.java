...
import org.symphonyoss.symphony.pod.model.V2AdminStreamInfo;
import org.symphonyoss.symphony.pod.model.V2AdminStreamInfoList;
...
public class SymAdminStreamInfo {
     ...
     * @return
     */
    public static List<SymAdminStreamInfo> toStreamInfos(V2AdminStreamInfoList streams) {
    	
    	List<SymAdminStreamInfo> symAdminStreamInfos = new ArrayList<>();
    	for (V2AdminStreamInfo adminStreamInfo : streams) {
    		symAdminStreamInfos.add(SymAdminStreamInfo.toStreamInfo(adminStreamInfo));
    	}
    ...
    /**
     * V2
     * @param adminStreamInfo
     * @return
     */
    private static SymAdminStreamInfo toStreamInfo(V2AdminStreamInfo adminStreamInfo) {
    	...
    	symAdminStreamInfo.setIsPublic(adminStreamInfo.getIsPublic());
    	symAdminStreamInfo.setType(adminStreamInfo.getType());
    	symAdminStreamInfo.setAttributes(SymAdminStreamAttributes.toV2AdminStreamAttributes(adminStreamInfo.getAttributes()));
    	return symAdminStreamInfo;
    }
}
